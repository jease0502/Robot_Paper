...
Cliff's $\delta$ is reported against ZOH. Track.\ is commanded-velocity
tracking error normalised to the ZOH baseline; larger is worse.}
...
swept. The reward ablations now carry five seeds and paired intervals, while
every other experiment here remains single-seed, with no confidence
